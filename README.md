# Команда 
* Афанасьева Екатерина - тимлид. Занимается архитектурой проекта, описанием функций и сообщений бота.
* Горбунов Павел - разработчик. Занимается парсингом сайта.
* Шкут Надежда - разработчик. Занимается сборкой данных о пользователях.
